    ...
    <div class="need-breadcrumb">
      <div class="need-breadcrumb-inner">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>找服务</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
    </div>
      ...
      <div class="private-list-inner">
        <el-row>
          <el-col :span="16">
            ...
            <el-row :gutter="15" class="need-left-list">
              <el-col :span="8" v-for="(item,key) in newBoxList" :key="key" >
                <div class="service-list">
                  <div class="service-img"><img :src="item.url"></div>
                  <h3>{{item.title}}</h3>
                  <h4>{{item.way}}</h4>
                  <el-row>
                    <el-col :span="8">
                  ...
                  <h6><i class="iconfont-hjy icon-hjyshouye"></i>{{item.company}}>></h6>
                </div>
              </el-col>
            </el-row>
            <el-pagination
...
export default {
  ...
  data() {
    ...
    return {
      ...
      //else
      cur: 0,
      dataTitle: ["找服务", "找企业", "找专家","找科研机构", "找专业服务公司"],

      curSort: 0,
      up: true,
      dataSort: ["综合", "价格", "交易量", "浏览量"],

      newBoxList: [
        {
          url:'/img/weihai-service_03.png',
          title: "码垛机器人",
          way: "价格面议",
          dealNum:2,
          lookNum:40,
          serviceArea:'不限',
          company: "北京正兴天宝自动化科技有限公司",
        },
        {
          url:'/img/weihai-service_03.png',
          title: "码垛机器人",
      ...
      .need-left-list {
        ...
        .service-list{
          ...
          h4{
            ...
            color: #ffa92a;
            font-weight: normal;
            border-bottom: 1px dashed $color-back-first;
          }
          .el-col{
            text-align: center;
            padding: 10px 0;
            ...
            font-size: 13px;
            border-right: 1px dashed $color-back-first;
